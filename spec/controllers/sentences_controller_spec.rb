  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved sentence as @sentence" do
        ...
        post :create, {:sentence => { "english" => "invalid value" }}, valid_session
        assigns(:sentence).should be_a_new(Sentence)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sentence" do
        ...
        Sentence.any_instance.should_receive(:update_attributes).with({ "english" => "MyString" })
        put :update, {:id => sentence.to_param, :sentence => { "english" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sentence as @sentence" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Sentence.any_instance.stub(:save).and_return(false)
        put :update, {:id => sentence.to_param, :sentence => { "english" => "invalid value" }}, valid_session
        assigns(:sentence).should eq(sentence)
      end
